...
// This file defines the Account class, which represents a user's email account in the application.
export class Account {
    ...
    async performInitialSync() {
        try {
            // start the sync process using the access token
            ...
            console.log('Initial sync completed, so we have synced', allEmails.length, 'emails')
            // store the latest delta token for future incremental syncing
